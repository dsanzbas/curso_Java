...
public class Array_Gigante_Busqueda {
    public static void main(String[] args) {
        ...
        System.out.println("Ordenar Array secuencial - Hora fin    : " + new Timestamp(date1.getTime()));

        //Ordenar ArrayList
        System.out.println("Ordenar ArrayList        - Hora inicio : " + new Timestamp(date2.getTime()));

        Collections.sort(arrayList);

        System.out.println("Ordenar ArrayList        - Hora fin : " + new Timestamp(date3.getTime()));

        // Busqueda array secuencial

        System.out.println("Búsqueda array secuencial - Hora inicio : " + new Timestamp(date4.getTime()));
        for (i=0; i < array.length - 1; i++) {
            if (array[i] == input) {
                encontrado = true;
                break;
        ...
        System.out.println("Búsqueda array secuencial - Hora fin : " + new Timestamp(date5.getTime()));

        //Búsqueda arrayList

        System.out.println("Búsqueda arrayList        - Hora inicio : " + new Timestamp(date6.getTime()));
        ...
        System.out.println("Búsqueda arrayList        - Hora fin    : " + new Timestamp(date7.getTime()));
